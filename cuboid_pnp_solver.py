...
class CuboidPNPSolver(object):
    ...
    def solve_pnp(self, cuboid2d_points, pnp_algorithm = None):
        ...
        if pnp_algorithm is None:
            ...
            elif CuboidPNPSolver.cv2majorversion == 3 or CuboidPNPSolver.cv2majorversion == 4:
        ...
        #print("---------------------------------------------------")
        #print("Object2D: ",obj_2d_points)
        #print("---------------------------------------------------")
        #These should be world
        #print("Object3D: ",obj_3d_points)
        #print("---------------------------------------------------")
        #print("Cube3D: ",cuboid3d_points)
        #print("---------------------------------------------------")
        #print("intrinsic: ",self._camera_intrinsic_matrix)
        #print("---------------------------------------------------")
        ...
        if is_points_valid:
            ...
            if ret:
                ...
                #print("PoseCNN: 3D translation is the object center in camera coord")
                #print("________________________________________________________________________________")
                #print("translation returend by the PNP solver :\n",tvec)
                #print("________________________________________________________________________________")
                #print("location/object center in camera coord :\n",location)
                #print("________________________________________________________________________________")
                quaternion = self.convert_rvec_to_quaternion(rvec)
                rotation = np.array([x[0] for x in rvec])
        ...
        return location, quaternion, projected_points, rotation
